// Package prompt holds AISP specification constants and prompt builders.
package prompt

// AISPSpec is the full AISP 5.1 Platinum Specification.
const AISPSpec = `𝔸5.1.complete@2026-01-09
